...
def buttons_area(frame_button, table, font_form, font_button, x):
    ...
    def get_form():
        ...
        form_main(top_form, frame_form, True, None, table, font_form, 100, btn_new_record, btn_update)
    ...
    def edit_data(id_data, edit):
        if id_data is not None:
            if edit:
                ...
                form_main(top_form, frame_form, False, data, table, font_form, 100, btn_new_record, btn_update)
            else:
    ...
    btn_delete = Button(frame_button, text='Edit Note', command=lambda: edit_data(get_id(table), False), bg='#980009', font=font_button, fg='white', height=1, width=width_button, padx=15)
